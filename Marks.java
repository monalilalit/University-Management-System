...
public class Marks extends JFrame implements ActionListener{
    ...
    setLayout(null);
        ...
        JLabel heading = new JLabel("Pune Technical University");
        heading.setBounds(100, 10, 500, 25);
        heading.setFont(new Font("Tahoma", Font.BOLD, 20));
        add(heading);
        
        JLabel suheading = new JLabel("Result Of Examination 2024");
        suheading.setBounds(100, 50, 400, 50);
        suheading.setFont(new Font("Tahoma", Font.BOLD, 18));
        add(suheading);
        ...
        lblsemester.setBounds(60, 130, 500, 50);
